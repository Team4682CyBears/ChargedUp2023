...
public class ShooterAutomatic extends CommandBase
{
  ...
  private static final double shooterIntakeTargets[][] =
  {
    ...
    {Constants.jawsLowGoalPositionAngle - 5.0, Constants.jawsLowGoalPositionAngle + 5.0, Constants.bottomMotorForwardLowGoalSpeedRpm, 20.0, Constants.topMotorForwardLowGoalSpeedRpm, Constants.defaultMotorSpeedToleranceRpm}, // low ball shooter targets
