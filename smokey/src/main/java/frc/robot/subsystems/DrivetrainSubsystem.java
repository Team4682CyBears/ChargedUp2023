...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private void refreshRobotPosition() {
    ...
    // For NavX Testing
    SmartDashboard.putNumber("NavX Yaw", swerveNavx.getYaw());
    SmartDashboard.putNumber("NavX Pitch", swerveNavx.getPitch());
    SmartDashboard.putNumber("NavX Roll", swerveNavx.getRoll());
