...
public final class Constants {
    ...
    public static final double armPresetPositionConeScoreHighMetersY = 1.368 - Units.inchesToMeters(1);
    public static final double armPresetPositionConeScoreHighMetersZ = 1.089 - Units.inchesToMeters(1);
