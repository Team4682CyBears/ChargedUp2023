...
public final class Constants {
    ...
    public static final double armPresetPositionCubeGrabMetersY = 0.7873 + Units.inchesToMeters(4.5);
    public static final double armPresetPositionCubeGrabMetersZ = 0.8840 + Units.inchesToMeters(3.5);
    public static final double armPresetPositionCubeScoreHighMetersY = 1.368 - Units.inchesToMeters(0);
    public static final double armPresetPositionCubeScoreHighMetersZ = 1.089 - Units.inchesToMeters(0);
