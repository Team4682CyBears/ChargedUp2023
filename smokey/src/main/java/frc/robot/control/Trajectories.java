...
public class Trajectories {
    ...
    public Trajectories(DrivetrainSubsystem drivetrain){
        ...
        this.Node1Position = new Pose2d(0, 0, Rotation2d.fromDegrees(180));
        ...
        this.LeftTrajectory = SwerveTrajectoryGenerator.generateTrajectory(Node1Position, LeftWaypoints, End, config);
        ...
        this.RightTrajectory = SwerveTrajectoryGenerator.generateTrajectory(Node9Position, RightWaypoints, End, config);
