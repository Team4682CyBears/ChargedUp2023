...
// FRC - Charged Up - 2023
// File: MotorGo.java
// Intent: Forms a command to drive a single test motor to the spinning/running state.
// ************************************************************
...
public class MotorGo extends CommandBase
{
  ...
  public MotorGo(BeamBreakMotor motorSubsystem)
  {
  ...
  @Override
  public void execute() {
    beamBreakMotorSubsystem.runMotor();
    done = true;
  }
